...
export type CompareResult = {
  ...
  leftLines: number;
  rightLines: number;
  diffs: Array<{ line: number; left: string; right: string }>;
};
...
export function compareMarkdownStrings(left: string, right: string): CompareResult {
  ...
  const diffs: Array<{ line: number; left: string; right: string }> = [];
